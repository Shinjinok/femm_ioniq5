...
def main():
    ...
    for c in CIRCUIT_NAMES:
        ...
        dflux_dtheta = np.gradient(flux_array, angles_rad)

        # e = - omega_m * (dFlux / dtheta)
        emf = -omega_m * dflux_dtheta
        emf_data[c] = emf
